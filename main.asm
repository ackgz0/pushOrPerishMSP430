...
UPDATE_DISPLAY:
    ...
    cmp.w #0, r13              ; Toggle flag kontrol�
    jne DASH              ; E�er toggle flag 1 de�ilse, say�y� g�ster
    cmp.w #3, R4
    jeq DISPLAY_3
    cmp.w #2, R4
    jeq DISPLAY_2
...
DISPLAY_2:
	;cmp.b #1, r11              ; Toggle flag kontrol�
    ;jeq DASH              ; E�er toggle flag 1 de�ilse, say�y� g�ster
